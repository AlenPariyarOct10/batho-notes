...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        >
            <h1 class="text-5xl under">NoteBooks</h1>
            <nav>
                ...
                <table class="w-full table-auto">
                    ...
                    @forelse($notes as $note)
                        ...
                        <tr>
                            ...
                            >
                                <h5 class="font-medium text-black dark:text-white">{{$note->title}}</h5>
                            </td>
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <p class="text-black dark:text-white">
                                    @if($note->category!=="null")
                                        {{$note->category}}
                                    @else
                                        <span class="inline-flex rounded-full bg-red-600 bg-opacity-10 px-3 py-1 text-sm font-medium text-red-600">No Category</span>
                                    @endif
                                </p>
                            </td>
