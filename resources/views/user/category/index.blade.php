...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        >
            <h1 class="text-5xl under">Categories</h1>
            <nav>
                    ...
                    @forelse($allCategory as $category)
                        ...
                        <tr>
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <h5 class="font-medium text-black dark:text-white">{{$category->notebook_count}}</h5>
                            </td>
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <div class="flex items-center space-x-3.5">
                                    ...
                                    <form action="{{route('category.delete', $category->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                        <button type="button" class="hover:text-primary deleteCategoryBtn">
                                            <svg
                                                class="fill-current"
                                                width="18"
                                                height="18"
...
@push('js')
    ...
    <script>
        console.log('category confirm delete');
        document.addEventListener('DOMContentLoaded', function () {
            // Select all elements with the class 'deleteBtn'
            document.querySelectorAll('.deleteCategoryBtn').forEach(function (button) {
